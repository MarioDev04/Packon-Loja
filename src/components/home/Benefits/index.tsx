...
const IconDelivery = () => (
  <svg width="74" height="74" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
const IconPayment = () => (
  <svg width="74" height="74" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Chip do Cartão */}
    <path d="M6 14h2v2h-2z" fill="white" stroke="none" />
    <path d="M6 14h2v2h-2z" stroke="white" />
  </svg>
);
